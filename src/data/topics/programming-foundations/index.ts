...
export const programmingFoundations: Topic = {
  ...
  // ── Topic quiz (16 questions across all 8 lessons) ──
  quiz: [
    {
      id: 'pf-q1',
      kind: 'mcq',
  ...
  // ── Practice problems (10, escalating; mostly on-paper since C# starts next topic) ──
  practice: [
    {
      id: 'pf-p1',
      difficulty: 'easy',
    ...
    },
    {
      id: 'pf-p6',
      difficulty: 'medium',
      title: 'Predict the operator',
      prompt:
        'Say what each line produces and why: (a) 4 + 6 with both as numbers; (b) "4" + "6" with both as text; (c) "Score: " + 10. Explain how the types change the meaning of `+`.',
      hints: ['Numbers add; text joins.', 'When text meets a number with +, the number is turned into text.'],
    },
    {
      id: 'pf-p7',
      difficulty: 'medium',
